...
/**
 * The BillingDataSource implements all billing functionality for our application.
...
private const val SKU_DETAILS_REQUERY_TIME = 1000L * 60L * 60L * 1L // 1 hour
...
class BillingDataSource private constructor(
    ...
    suspend fun refreshPurchases() {
        ...
        val purchasesResult = billingClient.queryPurchasesAsync(BillingClient.ProductType.SUBS)
    ...
    suspend fun consumeInAppPurchase(sku: String) {
        val pr = billingClient.queryPurchasesAsync(BillingClient.ProductType.INAPP)
